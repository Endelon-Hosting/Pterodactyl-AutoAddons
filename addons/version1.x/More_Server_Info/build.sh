...
mkdir -p $PTERO/temp
curl -sSLo $PTERO/temp/More_Server_Info.tar.gz https://raw.githubusercontent.com/Endelon-Hosting/Pterodactyl-AutoAddons/"${SCRIPT_VERSION}"/addons/version1.x/More_Server_Info/More_Server_Info.tar.gz
tar -xzvf $PTERO/temp/More_Server_Info.tar.gz -C $PTERO/temp
cp -rf -- $PTERO/temp/More_Server_Info/* $PTERO
rm -rf $PTERO/temp
}
