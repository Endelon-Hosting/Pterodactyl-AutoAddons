...
mkdir -p $PTERO/temp
curl -sSLo $PTERO/temp/Server_Router_Icons.tar.gz https://raw.githubusercontent.com/Endelon-Hosting/Pterodactyl-AutoAddons/"${SCRIPT_VERSION}"/addons/version1.x/Server_Router_Icons/Server_Router_Icons.tar.gz
